...
- 용어 메모(2026-09-18): 이 문서에서 `Protected`로 표기된 Routine 관련 항목(`routine.py`, `inputs.py`, `routine_items`)은 BACKEND_COLLABORATION.md §2.4 기준 "Routine AI 소유"를 뜻한다. Movement(§Movement)는 별도 소관이다.
